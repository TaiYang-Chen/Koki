...
android {
    namespace = Environment.namespaces.refresh_header
...
dependencies {
    ...
    compileOnly(project(mapOf("path" to ":refresh-layout")))
    compileOnly(project(mapOf("path" to ":refresh-drawable-path")))
    compileOnly(project(mapOf("path" to ":refresh-header-material")))
