...
android {
    namespace = Environment.namespaces.refresh_layout
...
dependencies {
    ...
    compileOnly(project(mapOf("path" to ":refresh-footer-ball")))
    compileOnly(project(mapOf("path" to ":refresh-header-falsify")))
    compileOnly(project(mapOf("path" to ":refresh-header-radar")))
    compileOnly(project(mapOf("path" to ":refresh-header-two-level")))
